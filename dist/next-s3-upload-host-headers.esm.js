...
var makeRouteHandler = function makeRouteHandler(options) {
  ...
  var route = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(req, res) {
      var missing, config, bucket, filename, key, policy, sts, token;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 5:
              ...
              bucket = options.bucketName || process.env.S3_UPLOAD_BUCKET;
            ...
            case 14:
              _context.t0 = "next-s3-uploads/" + v4() + "/" + filename.replace(/\s/g, '-');
...
var missingEnvs = function missingEnvs() {
  var keys = ['S3_UPLOAD_KEY', 'S3_UPLOAD_SECRET', 'S3_UPLOAD_REGION'];
...
var _FileInput = /*#__PURE__*/forwardRef(function (_ref, forwardedRef) {
  var _ref$onChange = _ref.onChange,
      ...
      restOfProps = _objectWithoutPropertiesLoose(_ref, ["onChange"]);
...
var useS3Upload = function useS3Upload(_ref2) {
  var _ref2$apiHost = _ref2.apiHost,
      apiHost = _ref2$apiHost === void 0 ? '' : _ref2$apiHost;
  var ref = useRef();
  ...
  var uploadToS3 = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(file) {
      var filename, res, data, s3, params, s3Upload, uploadResult;
      return runtime_1.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return fetch(apiHost + "/api/s3-upload?filename=" + filename);
...
export { APIRoute, getImageData, useS3Upload };
//# sourceMappingURL=next-s3-upload-host-headers.esm.js.map
